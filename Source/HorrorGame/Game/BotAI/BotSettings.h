...
public:
	...
	UPROPERTY(
		Config, EditAnywhere, BlueprintReadOnly, Category = "Перемещение", DisplayName = "Коэф. замедления бега", meta = (ToolTip = "Коэффициент замедления при беге", ClampMin = 1.0f, UIMin = 1.0f))
	float RunSpeedParam;
