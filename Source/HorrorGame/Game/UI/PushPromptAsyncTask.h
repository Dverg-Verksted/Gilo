...
public:
	...
	static UPushPromptAsyncTask* ShowPrompt(
		UObject* WorldContext, APlayerController* PlayerController, UPARAM(meta = (AllowAbstract = false)) TSubclassOf<UGenericPromptBase> Class, const FPromptSetup& Setup);
